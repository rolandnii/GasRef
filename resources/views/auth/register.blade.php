<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            <x-input-label for="gps_location" :value="__('GPS Location')" />
            <x-text-input id="gps_location" class="block mt-1 w-full" type="text" name="gps_location" :value="old('gps_location')" required autocomplete="username" />
            <x-input-error :messages="$errors->get('gps_location')" class="mt-2" />
        </div>
